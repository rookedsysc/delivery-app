...
class UserOrderBusiness(
	...
	private val storeConverter: StoreRegisterConverter,
	...
	fun current(
		...
		return userOrderService
			.current(user?.id)
			.map { userOrderEntity ->
				val userOrderMenuEntityList = userOrderEntity.userOrderMenuList
				...
				val storeResponse = storeConverter.toResponse(userOrderEntity.store)
	...
	fun read(
		...
		return userOrderService
			.getUserOrderWithOutStatusWithThrow(orderId, user?.id)
			.let { userOrderEntity ->
